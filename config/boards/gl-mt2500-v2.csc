# GL.iNet GL-MT2500 / Brume 2, v2 with Airoha EN8811H 2.5G PHY
BOARD_NAME="GL.iNet GL-MT2500 v2"
...
function post_family_tweaks_bsp__gl_mt2500_v2_airoha_firmware() {
	...
	for index in "${!firmware_names[@]}"; do
		...
		run_host_command_logged curl --fail --location --retry 5 --retry-all-errors \
